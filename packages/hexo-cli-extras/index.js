...
hexo.extend.console.register(
  'edit',
  'Edit a post or draft with your favorite $EDITOR',
  {
    desc: 'Edit a post or draft with your favorite $EDITOR. Filter on title (if applicable), before using optional arguments.',
    usage:
      '[title] [-a | --after MM-DD-YYYY] [-b | --before MM-DD-YYYY] [-c | --category CATEGORY] [-d | --draft | --drafts] [-f | --folder FOLDER] [-g | --gui] [-l | --layout LAYOUT] [-p | --page | --pages] [-t | --tag | --tags TAG]',
    arguments: [
    ...
    options: [
      ...
      {
        name: '-g, --gui',
        desc: 'Open file with associated GUI text editor. Default is to open in terminal using $EDITOR. If no $EDITOR is found, it will fall back to gui mode.'
      },
...
hexo.extend.console.register(
  ...
  'Rename a post or draft',
  {
    ...
    options: [
      {
        name: '-n, --new',
        desc: '(required) The new title. Wrap in single or double quotes if the title includes spaces.'
      }
    ]
  },
  require('./lib/rename')
...
hexo.extend.console.register(
  'isolate',
  'Isolate a post or page by temporarily removing all others from the build process',
  {
